...
export default function CTASection({
  ...
  return (
    <section className="relative overflow-hidden bg-brand-charcoal text-white safe-px py-16 sm:py-24 md:py-32">
      ...
      <div className="absolute inset-0 grid-pattern-dark opacity-15 pointer-events-none" />

      <div className="mx-auto max-w-4xl text-center relative z-10">
        {/* Top Status Pill */}
        <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 backdrop-blur-md border border-white/15 text-[11px] sm:text-xs font-bold uppercase tracking-widest text-brand-orange mb-5 sm:mb-6">
        ...
        <p className="text-base sm:text-lg md:text-xl text-white/75 max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed">
          {subtitle}
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5">
          ...
          <a
            ...
            className="touch-target inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full border border-white/20 bg-white/10 backdrop-blur-md px-7 sm:px-8 py-4 sm:py-5 text-sm sm:text-base font-semibold text-white transition-all hover:bg-white/15 hover:border-white/40 active:scale-95"
          >
        ...
        <div className="mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-10 text-xs text-white/60">
